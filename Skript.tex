  ...
  \centering
    \begin{longtable}{rcl}
        ...
        \begin{tikzpicture}[scale=0.65]
            ...
            \node at (7.75,1.2) {$\scriptstyle \beta$};
            \draw (6cm,4cm) ++(0:0.5) arc (180:287:0.5cm);
            \node at (6.75,3.8) {$\scriptstyle \alpha$};
            \draw (2.225cm,3.595cm) ++(0:0.5) arc (-122:0:0.5cm);
            \node at (3.1,3.8) {$\scriptstyle \gamma$};
...
\begin{figure}
  \centering
  \begin{tikzpicture}
        \draw (1,1) -- (11,1) -- (11,11) -- (1,11) -- (1,1);
        \draw (1,11) -- (11,11) -- (16,16) -- (6,16) -- (1,11);
        \draw (1,2) -- (11,2) -- (16,7) -- (6,7) -- (1,2);
        \draw (1,1) -- (1,11);
        \draw (6,7) -- (6,16);
        \draw (11,1) -- (11,11);
        \draw (16,6) -- (16,16);

        \draw (1,1) -- (11,1) -- (11,2) -- (1,2);

        \draw (1.5,2.5) -- (11.5,2.5);
        \draw (2,3) -- (12,3);
        \draw (2.5,3.5) -- (12.5,3.5);
        \draw (5,6) -- (15,6);
        \draw (5.5,6.5) -- (15.5,6.5);
        ...
        \draw (9,4) -- (13,4);
        \draw (9.5,4.5) -- (13.5,4.5);
        \draw (10,5) -- (14,5);
        \draw (10.5,5.5) -- (14.5,5.5);
        ...
        \draw (13,3) -- (13,4);
        \draw (13.5,3.5) -- (13.5,4.5);
        \draw (14,4) -- (14,5);
        \draw (14.5,4.5) -- (14.5,5.5);
        \draw (15,5) -- (15,6);
        \draw (15.5,5.5) -- (15.5,6.5);
        
        \draw (11,1) -- (16,6);
        
        \draw (5,3.5) -- (5,4);
        \draw (5.5,3.5) -- (5.5,4.5);
        \draw (6,4) -- (6,5);
        \draw (6.5,4.5) -- (6.5,5.5);
        \draw (7,5) -- (7,6);
        \draw (5.5,3.5) -- (7,5);
