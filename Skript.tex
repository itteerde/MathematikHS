...
Dieser Text soll dem ganzen Projekt nützlich sein. Der Text richtet sich an Euch, die Teilnehmer, und an die Dozenten/ Leher/ Betreuer. Der Teil \enquote{Konzept} ist für die Dozenten geschrieben und in großen Teilen für Euch unverständlich. Das ist kein Problem. Was Ihr heute nicht versteht hilft vielleicht in einem Jahr, vor der Prüfung, oder in vier Jahren vor der Prüfung in der Ausbildung. Den Teil \enquote{Konzept} brauchst Du nicht zu verstehen. Der Teil \enquote{Fachliche Inhalte} (s. \ref{FachlicheInhalte}, S. \pageref{FachlicheInhalte}) muss (bis zur Prüfung) vollständig gelernt werden, ausgenommen die Abschnitte, bei denen dabei steht, dass Du sie nicht lernen muss.
...
\section{Überschlagsrechnen}\index{Überschlagsrechnen}\label{Überschlagsrechnen}

Wir ordnen das \enquote{Überschlagsrechnen} (\citep[S. 8]{LehrplanMathematikHauptschuleHessen2017}) und systematisches Schätzen\footnote{Am Ende des Projektdurchlaufes wäre die Idealvorstellung einfache sog. \enquote{Fermi-Probleme} selbständig lösen zu können, was der Autor auch für einen guten Test hält ob, abgesehen vom sprachlichen Niveau in Deutsch als Fremdsprache, voll umfänglich die Basis für beliebige Ausbildungsgänge gelegt ist.} der Bruchrechnung unter, da auf diesem Weg für die Meisten die präzisesten Abschätzungen vorgenommen werden können, oft als Hundertstel, also in Prozenten.
