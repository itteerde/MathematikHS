...
Löse für $x$ auf kariertem Papier. Achte auf eine gut lesbare/ nachvollziehbare Notation und Aufteilung.
...
% \nonumber % Remove numbering (before each equation)
  ...
  1,236.78\footnote{Dies ist eine etwas weniger gebräuchliche Notation. Nach dem Komma macht es Sinn von links 3er-Gruppen zu bilden, denn das sind die Tripel des \gls{SISystem}, hier $236\text{mg}$.} \text{g} &=& x \text{t} \\
