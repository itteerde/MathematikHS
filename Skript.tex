...
\begin{figure}
  ...
  \begin{tikzpicture}
        ...
        \node (b) at (1.85,2) {b};
  \end{tikzpicture}
  \caption{eine Seite und beide an ihren Eckpunkten liegende Winkel}\label{fig:DreieckSeiteUndBeideDaranLiegendenWinkel2}
\end{figure}
