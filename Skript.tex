...
Mit dem Meter messen wir Entfernungen, Längen, Strecken. Alle anderen Maßeinheiten für Strecken werden durch den Meter definiert. Ein Millimeter ist ein tausendstel Meter. \enquote{Milli} ist das Präfix für $\frac{1}{1000}$.
...
\begin{figure}
  ...
  \caption{Umwandlungen von Strecken (m)}\label{fig:sisystemMUmwandlungen}
\end{figure}
