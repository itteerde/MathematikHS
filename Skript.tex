...
Dieser Text soll dem ganzen Projekt nützlich sein. Der Text richtet sich an Euch, die Teilnehmer, und an die Dozenten/ Leher/ Betreuer. Der Teil \enquote{Konzept} ist für die Dozenten geschrieben und in großen Teilen für Euch unverständlich. Das ist kein Problem. Was Ihr heute nicht versteht hilft vielleicht in einem Jahr, vor der Prüfung, oder in vier Jahren vor der Prüfung in der Ausbildung. Den Teil \enquote{Konzept} brauchst Du nicht zu verstehen. Der Teil \enquote{Fachliche Inhalte} (s. \ref{FachlicheInhalte}, S. \pageref{FachlicheInhalte}) muss (bis zur Prüfung) vollständig gelernt werden, ausgenommen dei Abschnitte, bei denen dabei steht, dass Du sie nicht lernen muss.
